...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ks3szqq.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ks3szqq.containers.anotherwebservice.com/
...
```
git clone git@github.com:Banana-Bond/container-ks3szqq.git
cd container-ks3szqq
```
...
```
docker attach container-ks3szqq
```
